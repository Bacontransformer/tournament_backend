...
alter table tournament.match_b
    add column referee_name varchar(100) not null comment '裁判姓名' ,
add column substitute_referee_name varchar(100) null comment '替补裁判姓名';


CREATE TABLE tournament.match_mode
(
    match_mode_id             INT AUTO_INCREMENT PRIMARY KEY,
    match_a_id                INT                                NULL,
    mode                      VARCHAR(50)                        NOT NULL COMMENT '模式',
    venue_number              INT                                NULL,
    referee_id                INT                                NULL,
    referee_name              VARCHAR(100)                       NULL COMMENT '裁判姓名',
    substitute_referee_id     INT                                NULL,
    substitute_referee_name   VARCHAR(100)                       NULL COMMENT '替补裁判姓名',
    team_a_id                 INT                                NULL,
    team_b_id                 INT                                NULL,
    mode_winner_team_id       INT                                NULL,
    begin_time                DATETIME                           NOT NULL COMMENT '比赛开始时间',
    status                    INT                                NULL,
    team_a_player1            INT                                NULL,
    team_a_player1_name       VARCHAR(100)                       NULL COMMENT 'a队参赛队员1号姓名',
    team_a_player2            INT                                NULL,
    team_a_player2_name       VARCHAR(100)                       NULL COMMENT 'a队参赛队员2号姓名',
    team_b_player1            INT                                NULL,
    team_b_player1_name       VARCHAR(100)                       NULL COMMENT 'b队参赛队员1号姓名',
    team_b_player2            INT                                NULL,
    team_b_player2_name       VARCHAR(100)                       NULL COMMENT 'b队参赛队员2号姓名',
    team_a_substitute_player1 INT                                NULL,
    team_a_substitute_player1_name VARCHAR(100)                  NULL COMMENT 'a队替补1号姓名',
    team_a_substitute_player2 INT                                NULL,
    team_a_substitute_player2_name VARCHAR(100)                  NULL COMMENT 'a队替补2号姓名',
    team_b_substitute_player1 INT                                NULL,
    team_b_substitute_player1_name VARCHAR(100)                  NULL COMMENT 'b队替补1号姓名',
    team_b_substitute_player2 INT                                NULL,
    team_b_substitute_player2_name VARCHAR(100)                  NULL COMMENT 'b队替补2号姓名',
    team_a_round_score1       INT                                NULL,
    team_a_round_score2       INT                                NULL,
    team_a_round_score3       INT                                NULL,
    team_b_round_score1       INT                                NULL,
    team_b_round_score2       INT                                NULL,
    team_b_round_score3       INT                                NULL,
    team_a_game_score         INT                                NULL,
    team_b_game_score         INT                                NULL,
    current_game              INT                                NULL,
    current_round             INT                                NULL,
    create_time               DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT '创建时间',
    update_time               DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间'
) COMMENT '传统比赛某一模式的信息表';

ALTER TABLE tournament.match_mode
    ADD COLUMN game_count INT NULL COMMENT '该模式一共几局';
ALTER TABLE tournament.match_mode
    ADD COLUMN team_a_department VARCHAR(100) NOT NULL COMMENT 'a队部门',
ADD COLUMN team_b_department VARCHAR(100) NOT NULL COMMENT 'b队部门';
