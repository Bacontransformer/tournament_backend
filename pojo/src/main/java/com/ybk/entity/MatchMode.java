...
public class MatchMode {
    ...
    private Long matchModeId; // 主键 自增
    private Long matchAId; // 逻辑关联match-a的id 不可空
    private String mode; // 模式 不可空
    private Integer venueNumber; // 场地编号 不可空
    private Long refereeId; // 裁判id 不可空
    private Long substituteRefereeId; // 替补裁判id 可空
    private Long teamAId; // a队id  不可空
    private Long teamBId; // b队id  不可空
    private Long modeWinnerTeamId; // 该模式获胜的队伍id 可空
    private LocalDateTime beginTime; // 比赛开始时间 不可空
    private Integer status; // 0:未开始，1:进行中，2:已结束 默认为0
    private Long teamAPlayer1; // a队参赛队员1号 可空
    private Long teamAPlayer2; // a队参赛队员2号 可空
    private Long teamBPlayer1; // b队参赛队员1号 可空
    private Long teamBPlayer2; // b队参赛队员2号 可空
    private Long teamASubstitutePlayer1; // a队替补1号 可空
    private Long teamASubstitutePlayer2; // a队替补2号 可空
    private Long teamBSubstitutePlayer1; // b队替补1号 可空
    private Long teamBSubstitutePlayer2; // b队替补2号 可空
