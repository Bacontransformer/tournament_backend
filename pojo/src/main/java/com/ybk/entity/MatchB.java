...
public class MatchB {
    ...
    private Integer currentTeamAPlayerId1; // 当前teamA的1号选手 可为空
    private Integer currentTeamAPlayerId2; // 当前teamA的2号选手 可为空
    private Integer currentTeamBPlayerId1; // 当前teamB的1号选手 可为空
    private Integer currentTeamBPlayerId2; // 当前teamB的2号选手 可为空
